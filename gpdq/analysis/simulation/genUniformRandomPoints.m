...
%
% *otherPoints*: (nx2) matrix with reference points. They are used to
...
function randomPoints = genUniformRandomPoints(nPoints, region, rangeDistancesPx, otherPoints)
