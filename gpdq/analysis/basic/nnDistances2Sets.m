...
% -----
%
%       distances = nnDistances2Sets(setA, setB)
%
% Parameters
% ----------
%
...
% ------
%
%   If setA has no elements, returns NaN.
%   If setB has no elements, distances for each element in setA are set to NaN

% Author: Luis de la Ossa (luis.delaossa@uclm.es)

function distances = nnDistances2Sets(setA, setB)

% If the first set is empty, returns NaN.
if size(setA,1)==0
    distances=NaN;
    return
end
